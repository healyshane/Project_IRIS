...
plt.scatter(SL,SPEC, color = "red", label='Sepal Length',marker='h')
plt.scatter(SW,SPEC, color = "blue", label='Sepal Width',marker='h')
plt.scatter(PL,SPEC, color = "green", label='Petal Length',marker='h')
plt.scatter(PW,SPEC, color = "black", label='Petal Width',marker='h')
plt.legend(loc='upper left',fontsize=16)
plt.xlabel('cm',fontsize=18,color='black')
plt.ylabel('Species',fontsize=18,color='black')
plt.title('Scatter Plot of Iris Species', color = 'black', fontsize=20)
